...
The 2025 Advent of FPGA Challenge is a hardware engineering challenge hosted by Jane Street based on the annual Advent of Code (AoC) puzzles. The Advent of FPGA expands on the AoC and Jane Street’s puzzle solving culture by challenging participants to solve AoC puzzles by building synthesizable RTL with realistic I/O points. Additional emphasis and recognition is provided for those who build solutions using Hardcaml, Jane Street’s OCaml-based hardware DSL.

Key details for the challenge:
Deadline: all solutions should be submitted by January 16, 2026
...
Due to time constraints and my experience with Hardcaml, I will be solving the AoC Day 1 problem “Secret Entrance” for the Advent of FPGA.
